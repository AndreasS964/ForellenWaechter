 ...
 *  ✓ Energie-Optimierung (Off-Grid/Solar/Batterie)
 *  ✓ Modernes UI mit Dark Mode & Glassmorphism
 *  ✓ PWA Support (Progressive Web App)
 *  ✓ Verbesserte Sensor-Fehlerbehandlung
 ...
 *
 *  Hardware:
 *  - ESP32 DevKit (80MHz für Energiesparen)
 *  - DS18B20 Temperatursensoren (Wasser + Luft)
 *  - pH Sensor (Analog)
 *  - TDS Sensor (Analog)
 *  - 2x Float Switch (Wasserstand)
 *  - 4-Kanal Relais Modul
 *  - SD-Karte Modul (optional)
 *
 *  Lizenz: MIT
